...
⚠️ **12pp as of 2026-08-26** (was 11) after the related-work section was added — MK's standing instruction was 11pp; page not recoverable by trimming or typography, MK decision pending. ⚠️ **Adversarial pass does NOT cover `sec:related`**: two Codex attempts exhausted their turn on the 76-page SOLiD PDF without emitting a verdict. Writing-standards §5 unsatisfied for the new material.
