...
CI lower bound is $0.6705$. This licenses the narrow statement that the geometric floor extends to
HaluEval-QA when each model may use its own labeled calibration.
