...
(Appendix~\ref{app:signals}). \emph{Motivating hypothesis:} a well-supported readout concentrates on
...
token's own position, after it is fed back (Appendix~\ref{app:signals} gives each exactly).
...
\paragraph{RPV --- 3 signals, each a late-window average.} For a distribution $q$, let $S_q$ be its
