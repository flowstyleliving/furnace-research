...
\hypersetup{
  pdftitle={No Universal Detector, but a Universal Floor: Calibrated Early-Response Geometry for Input-Label Discrimination},
...
\title{\textbf{No Universal Detector, but a Universal Floor}\\[3pt]
