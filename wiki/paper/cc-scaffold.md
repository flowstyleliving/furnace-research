...
## Status
Research report drafted directly in `.tex` and launch-ready as of 2026-06-24. Numbers locked from the **registered sealed run** ([[results/confluence-seal-2026-06-11]], seed 20260612; repo tag `prereg-seal-20260612`), with post-seal scale/locus and precision-deconfound sections clearly marked as extensions that do **not** alter the sealed 18/20 endpoint.
...
6. **Label cost** — ~150–200 labels per deployment (knee ~n=100).
...
- **Fig 3** `fig3_label_efficiency.pdf` — fraction deployable vs n (E3).
