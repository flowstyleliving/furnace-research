...
and $20/28$ for a $7$B Qwen. One of those two models, \texttt{Qwen2.5-7B}, is in
our own panel, where the peak is likewise late; we do not measure a $3$B Llama, so
that half of the echo is suggestive only.
