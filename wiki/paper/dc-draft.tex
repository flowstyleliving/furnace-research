...
band is narrow; where it is assumed, it is assumed to be a constant fraction of depth. None of the
four reports a sweep supporting that constant. \Cref{sec:placement} is the nearest test of the
