...
E6 & cliff onset & gatekept on E5 == CONFIRM; then $\geq$9/12 AND $\geq$4/6 per task AND $\geq$2/4 per family AND $p_{grid}<0.05$ & gate closed (E5 did not CONFIRM); descriptive 2/12 & NOT TESTED -- no cliff endpoint was ever evaluated \\
E7 & cross-task peak distance & descriptive-registered, no bar, no verdict vocabulary & 6 models reported & descriptive \\
E8 & Llama mid-stack band context & descriptive-registered, no bar & P8 hit (band replicates at 3.1-70B); P9 hit (absent at 8B) & descriptive \\
