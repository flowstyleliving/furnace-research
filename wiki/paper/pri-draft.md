...
6. **Karpathy, A.** (2026). LLM Wiki: representational-dynamics methodology for language-model inspection. — `raw/papers/external/karpathy-llm-wiki.md`
7. **Kitti, M.S.R.** (2026a). Predictive Rupture Index v2: Fisher-Information Pullback as a Magnitude Detector for LLM Commitment. Internal Furnace Research preprint. — `raw/papers/furnace/furnace-2026-pri-v2.pdf`
8. **Kitti, M.S.R.** (2026b). Hallucinations Rupture at Commitment, Not at Encoding: Predictive Rupture Index Localizes Contradiction-Induced Failure to the First Generated Token. Internal Furnace Research preprint, 17 March 2026. — `raw/papers/furnace/furnace-2026-prediction-rupture-at-commitment.pdf`
...
11. **Wastl, M., Vamvas, J., Sennrich, R.** (2025). Token-Level Self-Consistency for Hallucination Detection. *Proceedings of SemEval-2025*. (UZH.) — `raw/papers/external/token-level-selfconsistency.pdf`
