...
\begin{figure}[htbp]
  ...
  passes 3-of-3 under both geometries, because residualization absorbs
  the bias (\Cref{sec:methods:jn}). Its \emph{magnitudes} are not:
...
\begin{itemize}[leftmargin=*, itemsep=2pt, topsep=2pt]
  ...
  directions. $\Dcross = -0.575$ at $r=32$ is the largest cross-stratum
  spread observed across all 156 cells of the model $\times$ rank
  $\times$ chain-length grid \emph{under the orientation rule used
...
\begin{description}[leftmargin=*, itemsep=4pt, topsep=2pt]
  ...
  unaffected --- 3-of-3 under both geometries, since residualization
  absorbs the bias --- though its magnitudes move (Qwen 2.5:
  $0.7445 \to 0.6687$ at matched $n=200$). The legacy pre-norm-$\dh$ code
