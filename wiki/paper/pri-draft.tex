...
\begin{itemize}[leftmargin=*, itemsep=2pt, topsep=2pt]
  ...
  \item \textbf{How the reported AUROCs are oriented.} Every AUROC in
  this paper is the \emph{oriented} quantity
...
\begin{figure}[htbp]
  ...
  vertical). \textbf{The transition is an artifact of that orientation
  rule:} under a single sign fixed in the registered direction, Raw is
  decisive at all 13 ranks and no flip occurs. Retained to show what
  the fitted rule renders, not as evidence of a spectral transition.}
  \label{fig:gemma}
\end{figure}
...
and Fisher's per-sample reweighting cannot add. Only Phi is genuinely
saturated at the sealed rank; Mistral's Raw reaches $0.9991$ at
