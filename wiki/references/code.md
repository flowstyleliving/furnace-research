...
- **`t0-morphology-furnace`** — the morphology line (split out 2026-06-06; was a "living lab" 2026-06-07 → **2026-07-25 RE-SEALED as archive-only**). Its working tree must stay byte-identical to the sealed tag `t0-ace-sealed-2026-05-26` — that byte-identity is the basis for the packaging tag `t0-pkg-v0.1.0`. **Do not touch t0.** New unsealed morphology lanes now live in **`commit-confluence/exploratory/`** (which imports the sealed selector read-only), NOT in t0. Path `/Users/msrk/Documents/t0-morphology-furnace/`; GitHub `flowstyleliving/t0-morphology-furnace`. (`exploratory/shadow-ambiguity/` remains as committed t0 history, not live work.)
