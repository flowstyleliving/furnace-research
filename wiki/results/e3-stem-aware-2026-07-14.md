...
**Why it matters:** the paper (`wiki/paper/cc-draft.tex`) claims *"per-deployment calibration
...
## Verdict — the ~150–200 claim survives verbatim

At **150 labels, 14/18 deployable deployments reach ≥0.8 deployability on BOTH endpoints** —
identical before and after A2. The correction does not move the paper's number.
...
The "~150–200 labels" figure was never uniform. Deployments still short of 0.8 at 150 labels (NEW):
